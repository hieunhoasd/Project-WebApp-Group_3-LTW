    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <ul className="footer_list">
            <li><a href="#" className="footer-item__link">Địa chỉ: Trường Đại Học Giao Thông Vận Tải TP.HCM</a></li>
            <li><a href="#" className="footer-item__link">Số điện thoại:0352.456.789</a></li>
        ...
        <div className="footer-column">
          ...
          <ul className="footer_list">
            <li><a href="#" className="footer-item__link">Quần áo nam</a></li>
            <li><a href="#" className="footer-item__link">Quần áo nữ</a></li>
            <li><a href="#" className="footer-item__link">Áo khoác</a></li>
            <li><a href="#" className="footer-item__link">Giày</a></li>
          </ul>
        </div>
